...
async function main() {
  ...
  //report feedback to GPT and ask it to count how many answers were correct
  const tracker = await promptGPT(
      `I got quizzed on 4 questions and received the following feedback: ${answers.join()}. 
      How many questions did I get right?
      Only answer how many questions I got right, no need to tell me the 
      feedback I received. Like this: You got (number) questions right.`,
      {temperature: 0.3}
    )
    say(tracker);
    say("");
